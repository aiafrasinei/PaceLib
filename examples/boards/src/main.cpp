...
bool init()
{
	...
	Tabber::BeginBlock("Bag");
		Tabber::BeginTabBlock("Chess");
			for(int i=0; i<8; i++) {
				for(int j=0; j<8; j++) {
					ButtonTexProp p = { {nullptr, {(Window::width*0.06) + i * Window::width/9, (Window::width*0.03) + j * Window::width/9, Window::width/10, Window::height/10}},
										{nullptr, {(Window::width*0.06) + i * Window::width/9, (Window::width*0.03) + j * Window::width/9, Window::width/10, Window::height/10}},
		...
		Tabber::BeginTabBlock("Shogi");
			for(int i=0; i<9; i++) {
				for(int j=0; j<9; j++) {
					ButtonTexProp p = { {nullptr, {(Window::width*0.06) + i * Window::width/10, (Window::width*0.02) + j * Window::width/10, Window::width/11, Window::height/11}},
										{nullptr, {(Window::width*0.06) + i * Window::width/10, (Window::width*0.02) + j * Window::width/10, Window::width/11, Window::height/11}},
										{100, 100, 100, 255}, {0, 0, 0, 255}, {120, 120, 120, 255}, false };
