...
Pentagon::Pentagon(std::string name, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float x5, float y5, SDL_Color color)
{
...
void Pentagon::Create(std::string name, Shape *parent, float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, float x5, float y5, SDL_Color color)
{
    parent->Add(new Pentagon(name, x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, color));
}
